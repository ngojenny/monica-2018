...
<?php if ( $onePageQuery->have_posts() ) : ?>
    ...
    <?php while ($onePageQuery->have_posts()) : $onePageQuery->the_post(); ?>
        ...
        <section id="<?php echo $post->post_name; ?>" class="publications">
            <div class="wrapper">
                <h2><?php the_title(); ?></h2>
                <div class="publication-page clearfix">
                    <h3><?php the_field('pub_feat_title') ?></h3>
                    <?php the_content(); ?>
                    <?php 
                        if( $cta_text ) { ?>
                            <a class="btn btn-accent btn-pub" href="<?php echo $cta_link ?>"><?php echo $cta_text ?></a>
                        <?php }  ?>
